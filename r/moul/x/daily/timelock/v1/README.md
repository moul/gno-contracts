...
gnokey maketx call -pkgpath gno.land/r/moul/x/daily/timelock/v1 \
...
View the queue by rendering the realm (`gno.land/r/moul/x/daily/timelock/v1`).

Live demo (agent address): https://topaz.testnets.gno.land/r/g12cs4cehujpffpjpywmkqj43m6u5ya53nj69sjz/timelock
...
![gno.land/r/moul/x/daily/timelock/v1 dependency graph](https://raw.githubusercontent.com/moul/gno-contracts/main/_assets/gno.land/r/moul/x/daily/timelock/v1/deps.png)
