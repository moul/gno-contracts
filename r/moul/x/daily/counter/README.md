...
gnokey maketx call -pkgpath "gno.land/r/REPLACE_ADDR/counter" \
  -func Inc -gas-fee 20000ugnot -gas-wanted 2000000 -broadcast -chainid sapphire-1 KEY

# Decrement it
gnokey maketx call -pkgpath "gno.land/r/REPLACE_ADDR/counter" \
  -func Dec -gas-fee 20000ugnot -gas-wanted 2000000 -broadcast -chainid sapphire-1 KEY

# Reset back to zero
gnokey maketx call -pkgpath "gno.land/r/REPLACE_ADDR/counter" \
  -func Reset -gas-fee 20000ugnot -gas-wanted 2000000 -broadcast -chainid sapphire-1 KEY
```
