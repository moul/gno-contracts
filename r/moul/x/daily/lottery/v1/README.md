...
gnokey maketx call -pkgpath gno.land/r/moul/x/daily/lottery/v1 -func Enter ...   # from alice
gnokey maketx call -pkgpath gno.land/r/moul/x/daily/lottery/v1 -func Enter ...   # from bob

# Anyone draws the winner and opens round 2
gnokey maketx call -pkgpath gno.land/r/moul/x/daily/lottery/v1 -func DrawWinner ...
```

Read-only helpers: `CurrentRound()`, `NumEntrants()`, `HasEntered(addr)`.

Live demo (agent address): https://topaz.testnets.gno.land/r/g12cs4cehujpffpjpywmkqj43m6u5ya53nj69sjz/lottery
...
![gno.land/r/moul/x/daily/lottery/v1 dependency graph](https://raw.githubusercontent.com/moul/gno-contracts/main/_assets/gno.land/r/moul/x/daily/lottery/v1/deps.png)
